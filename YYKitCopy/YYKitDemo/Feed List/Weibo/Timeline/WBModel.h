...
@property (nonatomic, assign) int32_t width; ///< pixel width
@property (nonatomic, assign) int32_t height; ///< pixel height
@property (nonatomic, strong) NSString *type; ///< "WEBP" "JPEG" "GIF"
@property (nonatomic, assign) int32_t cutType; ///< Default:1
...
@property (nonatomic, assign) int32_t photoTag;
...
//http://blog.csdn.net/zhao18933/article/details/46925675
